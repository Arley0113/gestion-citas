...
export function Layout({ children }) {
  ...
  const { isProfessional, isCoordination, isAdmin, isAprendiz, profile, signOut } = useAuth();
  ...
  // In DEV preview mode show a hardcoded badge count
  const notifBadge = IS_DEV ? 2 : 0;
